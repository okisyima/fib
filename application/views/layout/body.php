<!-- Start of Body -->
  ...
  <body>
		  			...
		  			<div class="container">
				  		<div class="row">
				  			...
				  			<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
				  				<a href="tel:+953 012 3654 896">+62 21 8661 5774</a>
				  				<a href="mailto:fib@fib-berdikari.com">fib@fib-berdikari.com</a>
				  			</div>
				  		</div>
		  			</div>
				</div>
              ...
              <!-- Start Edit Logo -->
				      ...
				      <div id="logo">
				        <a href="index.html"><img src="<?php echo base_url(); ?>assets/img/logo1.png" alt="" title="" /></a>
				      </div>
